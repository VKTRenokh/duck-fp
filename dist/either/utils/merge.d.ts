import { Either, GetLeft, GetRight } from '../../either';
export type GetRightFromArray<T extends Array<Either<any, any>>> = {
    [K in keyof T]: GetRight<T[K]>;
};
export type GetLeftFromArray<T extends Array<Either<any, any>>> = {
 ...
 */
export declare const merge: <MT extends Either<L, any>[], L = GetLeftFromArray<MT>[number]>(...e: MT) => Either<L, GetRightFromArray<MT>>;
